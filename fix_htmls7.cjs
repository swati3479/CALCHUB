    ...
    <div class="max-w-2xl mx-auto space-y-6">
      <div class="bg-gradient-to-br from-white to-slate-50 dark:from-slate-900 dark:to-slate-950 border border-slate-200/50 dark:border-slate-800 rounded-[2.5rem] shadow-2xl p-6 md:p-8">
        ...
        <div id="simple-keys" class="grid grid-cols-4 gap-3 font-mono">
          <button data-val="C" class="col-span-2 py-4 bg-rose-50 text-rose-600 hover:bg-rose-100 dark:bg-rose-900/20 dark:hover:bg-rose-900/40 rounded-2xl text-xl font-bold">C</button>
          <button data-val="DEL" class="py-4 bg-slate-100 text-slate-600 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 rounded-2xl text-xl font-bold">DEL</button>
          <button data-val="/" class="py-4 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:hover:bg-indigo-900/50 rounded-2xl text-2xl font-bold">÷</button>
          <button data-val="7" class="py-4 bg-white border border-slate-100 hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 rounded-2xl text-2xl font-bold text-slate-700 dark:text-slate-200">7</button>
          <button data-val="8" class="py-4 bg-white border border-slate-100 hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 rounded-2xl text-2xl font-bold text-slate-700 dark:text-slate-200">8</button>
          <button data-val="9" class="py-4 bg-white border border-slate-100 hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 rounded-2xl text-2xl font-bold text-slate-700 dark:text-slate-200">9</button>
          <button data-val="*" class="py-4 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:hover:bg-indigo-900/50 rounded-2xl text-2xl font-bold">×</button>
          <button data-val="4" class="py-4 bg-white border border-slate-100 hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 rounded-2xl text-2xl font-bold text-slate-700 dark:text-slate-200">4</button>
          <button data-val="5" class="py-4 bg-white border border-slate-100 hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 rounded-2xl text-2xl font-bold text-slate-700 dark:text-slate-200">5</button>
          <button data-val="6" class="py-4 bg-white border border-slate-100 hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 rounded-2xl text-2xl font-bold text-slate-700 dark:text-slate-200">6</button>
          <button data-val="-" class="py-4 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:hover:bg-indigo-900/50 rounded-2xl text-2xl font-bold">-</button>
          <button data-val="1" class="py-4 bg-white border border-slate-100 hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 rounded-2xl text-2xl font-bold text-slate-700 dark:text-slate-200">1</button>
          <button data-val="2" class="py-4 bg-white border border-slate-100 hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 rounded-2xl text-2xl font-bold text-slate-700 dark:text-slate-200">2</button>
          <button data-val="3" class="py-4 bg-white border border-slate-100 hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 rounded-2xl text-2xl font-bold text-slate-700 dark:text-slate-200">3</button>
          <button data-val="+" class="py-4 bg-indigo-50 text-indigo-600 hover:bg-indigo-100 dark:bg-indigo-900/30 dark:hover:bg-indigo-900/50 rounded-2xl text-2xl font-bold">+</button>
          <button data-val="0" class="col-span-2 py-4 bg-white border border-slate-100 hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 rounded-2xl text-2xl font-bold text-slate-700 dark:text-slate-200">0</button>
          <button data-val="." class="py-4 bg-white border border-slate-100 hover:bg-slate-50 dark:bg-slate-900 dark:border-slate-800 dark:hover:bg-slate-800 rounded-2xl text-2xl font-bold text-slate-700 dark:text-slate-200">.</button>
          <button data-val="=" class="py-4 bg-indigo-600 text-white hover:bg-indigo-700 rounded-2xl text-2xl font-bold shadow-lg shadow-indigo-600/20">=</button>
        </div>
      </div>
...
const firstFunc = code.indexOf('function getSimpleCalcHTML() {');
const endFunc = code.indexOf('function getPercentageCalcHTML() {');

if (firstFunc !== -1 && endFunc !== -1) {
  code = code.substring(0, firstFunc) + replacement + '\n' + code.substring(endFunc);
  
  // also restore the original data-val read to be safe
  code = code.replace(/const val = btn\.dataset\.val \|\| btn\.textContent\.trim\(\);/g, 'const val = btn.dataset.val;');
  
  fs.writeFileSync('script.js', code);
  console.log("Replaced Simple and Scientific properly.");
} else {
